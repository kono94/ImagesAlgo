...
public class UtilityBar extends JComponent {
	...
	public UtilityBar(View view, Model m) {
		...
		color1Button.setPreferredSize(new Dimension(18, 18));
		color1Button.setBackground(new Color(m_Model.getColor1()));
		JButton color2Button = new JButton();
		color2Button.setPreferredSize(new Dimension(18, 18));
		color2Button.setBackground(new Color(m_Model.getColor2()));
		
		colorSelection.add(color1Button);
		colorSelection.add(color2Button);
	...
	public boolean loadIcons() {
		try {
			...
			m_moveTop = new Icon(ImageIO.read(new File("icons/moveTop.png")), ImageIO.read(new File("icons/moveTopPressed.png")), Model.MOVE_TOP);
			m_moveRight = new Icon(ImageIO.read(new File("icons/moveRight.png")),ImageIO.read(new File("icons/moveRightPressed.png")), Model.MOVE_RIGHT);
			m_moveBottom = new Icon(ImageIO.read(new File("icons/moveBottom.png")), ImageIO.read(new File("icons/moveBottomPressed.png")), Model.MOVE_BOTTOM);
			m_moveLeft = new Icon(ImageIO.read(new File("icons/moveLeft.png")), ImageIO.read(new File("icons/moveLeftPressed.png")),Model.MOVE_LEFT);		
			m_scaleBigger = new Icon(ImageIO.read(new File("icons/scaleBigger.png")), ImageIO.read(new File("icons/scaleBiggerPressed.png")),Model.SCALE_BIGGER);	
			m_scaleSmaller = new Icon(ImageIO.read(new File("icons/scaleSmaller.png")), ImageIO.read(new File("icons/scaleSmallerPressed.png")),Model.SCALE_SMALLER);		


			m_rotateLeft = new Icon(ImageIO.read(new File("icons/rotateLeft.png")), ImageIO.read(new File("icons/rotateLeftPressed.png")), Model.ROTATE_LEFT);
			m_rotateRight = new Icon(ImageIO.read(new File("icons/rotateRight.png")), ImageIO.read(new File("icons/rotateRightPressed.png")), Model.ROTATE_RIGHT);
			m_shearX = new Icon(ImageIO.read(new File("icons/shearX.png")), ImageIO.read(new File("icons/shearXPressed.png")), Model.SHEARX);
			m_shearY = new Icon(ImageIO.read(new File("icons/shearY.png")),ImageIO.read(new File("icons/shearYPressed.png")), Model.SHEARY);
			m_swirl = new Icon(ImageIO.read(new File("icons/swirl.png")), ImageIO.read(new File("icons/swirlPressed.png")), Model.MOVE_TOP);
